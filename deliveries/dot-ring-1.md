...
* **Application Document:** In the case of a public [Dot-Ring Application](https://github.com/Chainscore/posg-apply/blob/master/applications/dot-ring.md) 
...
| 0d.    | Docker                     | [Dockerfile]()                                                                                                                                            | A Docker container for building and testing all functionality will be provided in the final delivery milestone, as the project is still evolving and additional structural changes are expected.                                                                                                    |
| 1.1    | Bandersnatch Curve Implementation | [dot_ring/curve/specs/bandersnatch.py](https://github.com/Chainscore/dot-ring/blob/m1_delivery/dot_ring/curve/specs/bandersnatch.py)                      | Complete Bandersnatch curve arithmetic with GLV endomorphism optimization, achieving ~40% faster scalar multiplication as per Masson et al.                                                                                                                                                         |
